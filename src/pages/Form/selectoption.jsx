...
const SelectOption = () => {
  ...
  return (
    <div className="w-full h-auto flex flex-col items-center min-h-screen overflow-y-hidden">
        ...
        <div className="w-full h-[196px]">
          <div className="h-full w-full">
            <RadioGroup className="h-full w-full flex flex-col gap-4 " onValueChange = {handleOptionChange}>
              <div  onClick={() => handleOptionChange("job")} className="w-full h-1/3 flex flex-row items-center gap-[20px] px-[30px] py-[16px] rounded-[10px] shadow-radio_box hover:cursor-pointer">
